...
pub struct Telemetry {
    ...
    communication_channel: MpscSender<TelemetryPayload>,
}
...
async fn send_data(communication_channel: &MpscSender<TelemetryPayload>, interface_name: String) {
    ...
    if interface_name.as_str() == "io.edgehog.devicemanager.SystemStatus" {
        ...
        let _ = communication_channel
            .send(TelemetryPayload::SystemStatus(sysstatus))
            .await;
    }
}
